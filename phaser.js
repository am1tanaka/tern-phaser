(function(mod) {
 ...
 "!define": {
  ...
  "anonymousPhaserGameConfig": {
   ...
   "enableDebug": {
    "!type": "bool",
    "!doc": "Enable {@link Phaser.Utils.Debug}. You can gain a little performance by disabling this in production."
   },
   "fullScreenScaleMode": {
    "!type": "number",
   ...
   "fullScreenTarget": {
    "!type": "+DOMElement",
    "!doc": "The DOM element on which the Fullscreen API enter request will be invoked."
   },
   "multiTexture": {
    "!type": "bool",
    "!doc": "Enable support for multiple bound Textures in WebGL. Same as `renderer: Phaser.WEBGL_MULTI`."
   },
   "parent": {
   ...
   "preserveDrawingBuffer": {
    "!type": "bool",
    "!doc": "Whether or not the contents of the stencil buffer is retained after rendering."
   },
   "renderer": {
    "!type": "number"
   },
   "resolution": {
    "!type": "number",
    "!doc": "The resolution of your game, as a ratio of canvas pixels to game pixels."
   },
   "scaleMode": {
    "!type": "number",
   ...
   "seed": {
    "!type": "number",
    "!doc": "Seed for {@link Phaser.RandomDataGenerator}."
   },
   "state": {
    "!type": "?"
   },
  ...
  "anonymousPhaserTextStyle": {
   ...
   "maxLines": {
    "!type": "number",
    "!doc": "The maximum number of lines to be shown for wrapped text."
   },
   "tabs": {
    "!type": "number",
 ...
 "clear": {
  "!type": "fn()",
  "!doc": "Resets the World, removes all bodies, constraints and springs."
 },
 "append": {
 ...
 "ContactEquation": {
  "prototype": {
   ...
   "getVelocityAlongNormal": {
    "!type": "fn() -> number",
    "!doc": "Get the relative velocity along the normal vector."
   }
  }
 },
 "Equation": {
 ...
 "on": {
  "!type": "fn(type: string, listener: fn()) -> +EventEmitter",
 ...
 "destroy": {
  "!type": "fn(record: +OverlapKeeperRecord) -> +OverlapKeeperRecordPool"
 },
 "tick": {
  "!type": "fn()",
 ...
 "PIXI": {
  ...
  "DisplayObject": {
   ...
   "prototype": {
    ...
    "destroy": {
     "!type": "fn()",
     "!doc": "Destroy this DisplayObject.\n\nRemoves any cached sprites, sets renderable flag to false, and nulls filters, bounds and mask.\n\nAlso iteratively calls `destroy` on any children."
    },
    "preUpdate": {
     "!type": "fn()",
     "!doc": "To be overridden by classes that require it."
    },
    "generateTexture": {
     "!type": "fn(resolution: number, scaleMode: number, renderer: +PIXI.CanvasRenderer|+PIXI.WebGLRenderer) -> +Phaser.RenderTexture",
     "!doc": "Generates a RenderTexture based on this DisplayObject, which can they be used to texture other Sprites.\nThis can be useful if your DisplayObject is static, or complicated, and needs to be reused multiple times.\n\nPlease note that no garbage collection takes place on old textures. It is up to you to destroy old textures,\nand references to them, so they don't linger in memory."
    },
    "updateCache": {
     "!type": "fn() -> +PIXI.DisplayObject",
     "!doc": "If this DisplayObject has a cached Sprite, this method generates and updates it."
    },
    "toGlobal": {
     "!type": "fn(position: +PIXI.Point) -> +PIXI.Point",
     "!doc": "Calculates the global position of this DisplayObject, based on the position given."
    },
    "toLocal": {
     "!type": "fn(position: +PIXI.Point, from: +PIXI.DisplayObject) -> +PIXI.Point",
     "!doc": "Calculates the local position of this DisplayObject, relative to another point."
    },
    "x": {
     "!type": "number",
     "!doc": "The horizontal position of the DisplayObject, in pixels, relative to its parent."
    },
    "y": {
     "!type": "number",
     "!doc": "The vertical position of the DisplayObject, in pixels, relative to its parent."
    },
    "worldVisible": {
     "!type": "bool",
     "!doc": "Indicates if this DisplayObject is visible, based on it, and all of its parents, `visible` property values."
    },
    "mask": {
     "!type": "+Phaser.Graphics",
     "!doc": "The mask applied to this DisplayObject. Set to `null` to remove an existing mask."
    },
    "filters": {
     "!type": "[?]",
     "!doc": "An Array of Phaser.Filter objects, or objects that extend them."
    },
    "cacheAsBitmap": {
     "!type": "bool",
     "!doc": "Cache this DisplayObject as a Bitmap. Set to `null` to remove an existing cached bitmap."
    }
   }
  },
  ...
  "Sprite.defaultAnchor": {
   "!type": "?",
   "!doc": "A Point-like object."
  },
  "PixiShader": {
  ...
  "WebGLRenderer": {
   ...
   "prototype": {
    "game": {
     "!type": "+Phaser.Game",
     "!doc": "A reference to the Phaser Game instance."
    },
    "type": {
     "!type": "number"
    },
  ...
  "BaseTexture": {
   "!type": "fn(source: string|+Canvas, scaleMode: number, resolution: number)",
 ...
 "module:PIXI": {
  ...
  "resize": {
   "!type": "fn(width: number, height: number)",
   "!doc": "Resizes the canvas view to the specified width and height"
  },
  "updateCompressedTexture": {
   "!type": "fn(texture: +Texture) -> bool",
   "!doc": "Updates and creates a WebGL compressed texture for the renderers context."
  },
  "updateTexture": {
   "!type": "fn(texture: +Texture) -> bool",
  ...
  "setContext": {
   "!type": "fn(gl: +WebGLContext)",
   "!doc": "Initialises the context and the properties."
  },
  "setBlendMode": {
  ...
  "pushMask": {
   ...
   "!doc": "This method adds it to the current stack of masks."
  },
  "popMask": {
   "!type": "fn(renderSession: ?)",
   "!doc": "Restores the current drawing context to the state it was before the mask was applied."
  },
  "bindGraphics": {
  ...
  "begin": {
   "!type": "fn(renderSession: +RenderSession, buffer: [?])"
  },
  "end": {
   "!type": "fn()"
  },
  ...
  "applyFilterPass": {
   "!type": "fn(filter: +Phaser.Filter, filterArea: +Texture, width: number, height: number)",
  ...
  "fromCanvas": {
   "!type": "fn(canvas: +Canvas, scaleMode: number) -> +Texture",
 ...
 "Phaser": {
  ...
  "WEBGL_MULTI": {
   "!type": "number",
   "!doc": "WebGL Renderer with MultiTexture support enabled."
  },
  "NONE": {
   "!type": "number",
  ...
  "HORIZONTAL": {
   "!type": "number",
   "!doc": "A horizontal orientation"
  },
  "VERTICAL": {
   "!type": "number",
   "!doc": "A vertical orientation"
  },
  "LANDSCAPE": {
   "!type": "number",
   "!doc": "A landscape orientation"
  },
  "PORTRAIT": {
   "!type": "number",
   "!doc": "A portrait orientation"
  },
  "ANGLE_UP": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face up."
  },
  "ANGLE_DOWN": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face down."
  },
  "ANGLE_LEFT": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face left."
  },
  "ANGLE_RIGHT": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face right."
  },
  "ANGLE_NORTH_EAST": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face north east."
  },
  "ANGLE_NORTH_WEST": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face north west."
  },
  "ANGLE_SOUTH_EAST": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face south east."
  },
  "ANGLE_SOUTH_WEST": {
   "!type": "number",
   "!doc": "The Angle (in degrees) a Game Object needs to be set to in order to face south west."
  },
  "TOP_LEFT": {
   "!type": "number",
   "!doc": "A constant representing a top-left alignment or position."
  },
  "TOP_CENTER": {
   "!type": "number",
   "!doc": "A constant representing a top-center alignment or position."
  },
  "TOP_RIGHT": {
   "!type": "number",
   "!doc": "A constant representing a top-right alignment or position."
  },
  "Phaser": {
   "LEFT_TOP": {
    "!type": "number",
    "!doc": "A constant representing a left-top alignment or position."
   }
  },
  "LEFT_TOP": {
   "!type": "number",
   "!doc": "A constant representing a left-center alignment or position."
  },
  "LEFT_BOTTOM": {
   "!type": "number",
   "!doc": "A constant representing a left-bottom alignment or position."
  },
  "CENTER": {
   "!type": "number",
   "!doc": "A constant representing a center alignment or position."
  },
  "RIGHT_TOP": {
   "!type": "number",
   "!doc": "A constant representing a right-top alignment or position."
  },
  "RIGHT_CENTER": {
   "!type": "number",
   "!doc": "A constant representing a right-center alignment or position."
  },
  "RIGHT_BOTTOM": {
   "!type": "number",
   "!doc": "A constant representing a right-bottom alignment or position."
  },
  "BOTTOM_LEFT": {
   "!type": "number",
   "!doc": "A constant representing a bottom-left alignment or position."
  },
  "BOTTOM_CENTER": {
   "!type": "number",
   "!doc": "A constant representing a bottom-center alignment or position."
  },
  "BOTTOM_RIGHT": {
   "!type": "number",
   "!doc": "A constant representing a bottom-right alignment or position."
  },
  "blendModes": {
   "!type": "?",
  ...
  "Utils": {
   ...
   "reverseString": {
    ...
    "!doc": "Takes the given string and reverses it, returning the reversed string.\nFor example if given the string `Atari 520ST` it would return `TS025 iratA`."
   },
   "getProperty": {
    "!type": "fn(obj: ?, prop: string) -> +any",
    "!doc": "Gets an object's property by string."
   },
   "setProperty": {
   ...
   "pad": {
    ...
    "!doc": "Takes the given string and pads it out, to the length required, using the character\nspecified. For example if you need a string to be 6 characters long, you can call:\n\n`pad('bob', 6, '-', 2)`\n\nThis would return: `bob---` as it has padded it out to 6 characters, using the `-` on the right.\n\nYou can also use it to pad numbers (they are always returned as strings):\n\n`pad(512, 6, '0', 1)`\n\nWould return: `000512` with the string padded to the left.\n\nIf you don't specify a direction it'll pad to both sides:\n\n`pad('c64', 7, '*')`\n\nWould return: `**c64**`"
   },
   "isPlainObject": {
    "!type": "fn(obj: ?) -> bool",
   ...
   "Debug": {
    "prototype": {
     ...
     "sprite": {
      "!type": "+Phaser.Image",
      "!doc": "If debugging in WebGL mode, this is the Image displaying the debug {@link #bmd BitmapData}."
     },
     "bmd": {
     ...
     "lineWidth": {
      "!type": "number",
      "!doc": "The width of the stroke on lines and shapes. A positive number."
     },
     "renderShadow": {
      "!type": "bool",
     ...
     "isDisabled": {
      "!type": "bool",
      "!doc": "If `enableDebug: false` is passed to {@link Phaser.Game} or if Phaser is built without the Debug class, this will be true."
     },
     "boot": {
      "!type": "fn()",
     ...
     "camera": {
      "!type": "fn(camera: +Phaser.Camera, color: string, filled: bool)",
      "!doc": "Marks the follow {@link #target} and {@link #deadzone}."
     },
     "cameraInfo": {
     ...
     "geom": {
      "!type": "fn(object: +Phaser.Rectangle|+Phaser.Circle|+Phaser.Point|+Phaser.Line, color: string, filled: bool, forceType: number)",
  ...
  "Line": {
   ...
   "prototype": {
    ...
    "rotateAround": {
     "!type": "fn(x: number, y: number, angle: number, asDegrees: bool) -> +Phaser.Line",
  ...
  "Matrix": {
   ...
   "prototype": {
    ...
    "toArray": {
     "!type": "fn(transpose: bool, array: +Float32Array) -> +Float32Array",
  ...
  "Point": {
   ...
   "prototype": {
    ...
    "set": {
     "!type": "fn(obj: ?, x: number, y: number) -> ?",
     "!doc": "Sets the `x` and `y` values of an object and returns the object."
    },
    "setToPolar": {
     "!type": "fn(azimuth: number, radius: number, asDegrees: bool) -> +Phaser.Point",
     "!doc": "Sets the `x` and `y` values of this Point object from a given polar coordinate."
    },
    "add": {
     "!type": "fn(x: number, y: number) -> +Phaser.Point",
    ...
    "limit": {
     "!type": "fn(max: number) -> +Phaser.Point",
     "!doc": "Alters the Point object so it's magnitude is at most the max value."
    },
    "isZero": {
     "!type": "fn() -> bool",
   ...
   "isPoint": {
    "!type": "fn() -> bool",
    "!doc": "Tests a Point or Point-like object."
   }
  },
  "Polygon": {
   ...
   "prototype": {
    ...
    "flattened": {
     "!type": "bool",
     "!doc": "Has this Polygon been flattened by a call to `Polygon.flatten` ?"
    },
    "type": {
     "!type": "number",
  ...
  "Camera": {
   ...
   "prototype": {
    ...
    "follow": {
     "!type": "fn(target: +Phaser.Sprite|+Phaser.Image|+Phaser.Text, style: number, lerpX: +float, lerpY: +float)",
    ...
    "shake": {
     "!type": "fn(intensity: +float, duration: number, force: bool, direction: number, shakeBounds: bool) -> bool",
    ...
    "flash": {
     "!type": "fn(color: +numer, duration: number, force: bool, alpha: +numer) -> bool",
    ...
    "shakeIntensity": {
     "!type": "number",
     "!doc": "Gets or sets the cameras shake intensity."
    }
   }
  },
  "Camera.FOLLOW_LOCKON": {
   "!type": "number",
   "!doc": "A follow style that uses no deadzone."
  },
  "Camera.FOLLOW_PLATFORMER": {
   "!type": "number",
   "!doc": "A follow style that uses a tall, narrow deadzone (0.33 x 0.125) with a center slightly above the view center."
  },
  "Camera.FOLLOW_TOPDOWN": {
   "!type": "number",
   "!doc": "A follow style that uses a square deadzone (0.25 of the larger view edge)."
  },
  "Camera.FOLLOW_TOPDOWN_TIGHT": {
   "!type": "number",
   "!doc": "A follow style that uses a small square deadzone (0.125 of the larger view edge)."
  },
  "Camera.SHAKE_BOTH": {
   "!type": "number"
  },
  ...
  "State": {
   ...
   "prototype": {
    ...
    "state": {
     ...
     "!doc": "A reference to the State Manager, which controls state changes."
    },
    "time": {
     "!type": "+Phaser.Time",
  ...
  "Filter": {
   ...
   "prototype": {
    ...
    "init": {
     "!type": "fn()",
     "!doc": "This should be over-ridden. Will receive a variable number of arguments."
    },
    "setResolution": {
     "!type": "fn(width: number, height: number)",
    ...
    "syncUniforms": {
     "!type": "fn()",
     "!doc": "Syncs the uniforms between the class object and the shaders."
    },
    "destroy": {
     "!type": "fn()",
     "!doc": "Clear down this Filter and null out references to game."
    },
    "width": {
     "!type": "number",
  ...
  "PluginManager": {
   ...
   "prototype": {
    ...
    "remove": {
     "!type": "fn(plugin: +Phaser.Plugin, destroy: bool)",
  ...
  "Group": {
   ...
   "prototype": {
    ...
    "add": {
     "!type": "fn(child: +DisplayObject, silent: bool, index: number) -> +DisplayObject",
    ...
    "create": {
     "!type": "fn(x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+Phaser.Video|+PIXI.Texture, frame: string|number, exists: bool, index: number) -> +DisplayObject",
    ...
    "createMultiple": {
     "!type": "fn(quantity: number, key: string|+array, frame: number|string|+array, exists: bool) -> +array",
    ...
    "checkProperty": {
     "!type": "fn(child: +any, key: string, value: +any, force: bool) -> bool",
    ...
    "checkAll": {
     "!type": "fn(key: string, value: +any, checkAlive: bool, checkVisible: bool, force: bool) -> bool",
     "!doc": "Test that the same property across all children of this group is equal to the given value.\n\nThis call doesn't descend down children, so if you have a Group inside of this group, the property will be checked on the group but not its children."
    },
    "checkAny": {
     "!type": "fn(key: string, value: +any, checkAlive: bool, checkVisible: bool) -> bool",
     "!doc": "Test that at least one child of this group has the given property value.\n\nThis call doesn't descend down children, so if you have a Group inside of this group, the property will be checked on the group but not its children."
    },
    "addAll": {
    ...
    "killAll": {
     "!type": "fn()",
     "!doc": "Kills all children having exists=true."
    },
    "reviveAll": {
     "!type": "fn()",
     "!doc": "Revives all children having exists=false."
    },
    "resetAll": {
     "!type": "fn(x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+Phaser.Video|+PIXI.Texture, frame: string|number, checkExists: bool)",
     "!doc": "Calls {@link #resetChild} on each child (or each existing child)."
    },
    "callAllExists": {
    ...
    "getFirstExists": {
     "!type": "fn(exists: bool, createIfNull: bool, x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+Phaser.Video|+PIXI.Texture, frame: string|number) -> +DisplayObject",
    ...
    "getFirstAlive": {
     "!type": "fn(createIfNull: bool, x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+Phaser.Video|+PIXI.Texture, frame: string|number) -> +DisplayObject",
    ...
    "resetChild": {
     "!type": "fn(child: +DisplayObject, x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+Phaser.Video|+PIXI.Texture, frame: string|number) -> +DisplayObject",
    ...
    "removeAll": {
     "!type": "fn(destroy: bool, silent: bool, destroyTexture: bool)",
    ...
    "scatter": {
     "!type": "fn(rect: +Phaser.Rectangle, checkExists: bool)",
     "!doc": "Places each child at a random position within the given Rectangle (or the {@link Phaser.World#bounds World bounds})."
    },
    "shuffle": {
     "!type": "fn()",
     "!doc": "Orders this Group's children randomly.\n\nThis can be more efficient than calling {@link #getRandom} repeatedly."
    },
    "destroy": {
  ...
  "Game": {
   "!type": "fn(config: +anonymousPhaserGameConfig)",
   "!doc": "Instead of specifying arguments you can also pass a single object instead:\n\n```\nvar config = {\n    width: 800,\n    height: 600,\n    renderer: Phaser.AUTO,\n    antialias: true,\n    multiTexture: true,\n    state: {\n        preload: preload,\n        create: create,\n        update: update\n    }\n}\n\nvar game = new Phaser.Game(config);\n```",
   "prototype": {
    "id": {
     "!type": "number",
     "!doc": "Phaser Game ID"
    ...
    "parent": {
     "!type": "string|+HTMLElement",
     "!doc": "The Game's DOM parent (or name thereof), if any, as set when the game was created. The actual parent can be found in `game.canvas.parentNode`. Setting this has no effect after {@link Phaser.ScaleManager} is booted."
    },
    "width": {
     "!type": "number"
    },
    ...
    "antialias": {
     "!type": "bool",
     "!doc": "Anti-alias graphics (as set when the Game is created). By default scaled and rotated images are smoothed in Canvas and WebGL; set `antialias` to false to disable this globally. After the game boots, use `game.stage.smoothed` instead."
    },
    "multiTexture": {
     "!type": "bool"
    },
    ...
    "renderType": {
     "!type": "number",
     "!doc": "The Renderer this game will use. Either Phaser.AUTO, Phaser.CANVAS, Phaser.WEBGL, Phaser.WEBGL_MULTI or Phaser.HEADLESS. After the game boots, renderType reflects the renderer in use: AUTO changes to CANVAS or WEBGL and WEBGL_MULTI changes to WEBGL. HEADLESS skips `render` hooks but not `preRender` or `postRender`; set {@link lockRender} to skip those as well."
    },
    "state": {
     "!type": "+Phaser.StateManager",
    ...
    "forceSingleUpdate": {
     "!type": "bool",
     "!doc": "Should the game loop force a logic update, regardless of the delta timer? You can toggle it on the fly."
    },
    "parseConfig": {
     "!type": "fn()",
     "!doc": "Parses a Game configuration object."
  ...
  "PointerMode": {
   ...
   "CURSOR": {
    "!type": "?",
    "!doc": "A 'CURSOR' is a pointer with a *passive cursor* such as a mouse, touchpad, watcom stylus, or even TV-control arrow-pad.\n\nIt has the property that a cursor is passively moved without activating the input.\nThis currently corresponds with {@link Phaser.Pointer#isMouse} property."
   },
   "CONTACT": {
    "!type": "?",
    "!doc": "A 'CONTACT' pointer has an *active cursor* that only tracks movement when actived; notably this is a touch-style input."
   }
  },
  "Touch": {
   "!type": "fn(game: +Phaser.Game)",
   ...
   "prototype": {
    ...
    "addTouchLockCallback": {
     "!type": "fn(callback: fn(), context: ?, onEnd: bool)",
  ...
  "InputHandler": {
   ...
   "prototype": {
    ...
    "dragStopBlocksInputUp": {
     "!type": "bool",
     "!doc": "If enabled, when the Sprite stops being dragged, it will only dispatch the `onDragStop` event, and not the `onInputUp` event. If set to `false` it will dispatch both events."
    },
    "dragStartPoint": {
     "!type": "+Phaser.Point",
    ...
    "dragDistanceThreshold": {
     "!type": "number",
     "!doc": "The distance, in pixels, the pointer has to move while being held down, before the Sprite thinks it is being dragged."
    },
    "dragTimeThreshold": {
     "!type": "number",
     "!doc": "The amount of time, in ms, the pointer has to be held down over the Sprite before it thinks it is being dragged."
    },
    "downPoint": {
     "!type": "+Phaser.Point",
     "!doc": "A Point object containing the coordinates of the Pointer when it was first pressed down onto this Sprite."
    },
    "snapPoint": {
     "!type": "+Phaser.Point",
    ...
    "update": {
     ...
     "!doc": "Internal Update method. This is called automatically and handles the Pointer\nand drag update loops."
    },
    "justOver": {
     "!type": "fn(pointerId: number, delay: number) -> bool",
    ...
    "globalToLocal": {
     "!type": "fn(globalCoord: +Phaser.Point) -> +Phaser.Point",
     "!doc": "Convert global coordinates to local sprite coordinates"
    },
    "stopDrag": {
     "!type": "fn(pointer: +Phaser.Pointer)",
  ...
  "Key": {
   ...
   "prototype": {
    ...
    "durationUp": {
     "!type": "number",
     "!doc": "The number of milliseconds this key has been up for."
    },
    "repeats": {
     "!type": "number",
    ...
    "justPressed": {
     "!type": "fn() -> bool",
     "!doc": "Returns `true` if the Key was just pressed down this update tick, or `false` if it either isn't down,\nor was pressed down on a previous update tick."
    },
    "justReleased": {
     "!type": "fn() -> bool",
     "!doc": "Returns `true` if the Key was just released this update tick, or `false` if it either isn't up,\nor was released on a previous update tick."
    },
    "justDown": {
     "!type": "bool"
    },
  ...
  "Keyboard": {
   ...
   "prototype": {
    ...
    "start": {
     "!type": "fn()",
     "!doc": "Starts the Keyboard event listeners running (keydown, keyup and keypress). They are attached to the window.\nThis is called automatically by Phaser.Input and should not normally be invoked directly."
    },
    "stop": {
     "!type": "fn()",
    ...
    "upDuration": {
     "!type": "fn(keycode: +Phaser.KeyCode|number, duration: number) -> bool",
     "!doc": "Returns `true` if the Key was pressed down within the `duration` value given, or `false` if it either isn't down,\nor was pressed down longer ago than then given duration."
    },
    "isDown": {
  ...
  "Component": {
   ...
   "Bounds": {
    "prototype": {
     ...
     "alignIn": {
      "!type": "fn(container: +Phaser.Rectangle|+Phaser.Sprite|+Phaser.Image|+Phaser.Text|+Phaser.BitmapText|+Phaser.Button|+Phaser.Graphics|+Phaser.TileSprite, position: number, offsetX: number, offsetY: number) -> ?",
      "!doc": "Aligns this Game Object within another Game Object, or Rectangle, known as the\n'container', to one of 9 possible positions.\n\nThe container must be a Game Object, or Phaser.Rectangle object. This can include properties\nsuch as `World.bounds` or `Camera.view`, for aligning Game Objects within the world \nand camera bounds. Or it can include other Sprites, Images, Text objects, BitmapText,\nTileSprites or Buttons.\n\nPlease note that aligning a Sprite to another Game Object does **not** make it a child of\nthe container. It simply modifies its position coordinates so it aligns with it.\n\nThe position constants you can use are:\n\n`Phaser.TOP_LEFT`, `Phaser.TOP_CENTER`, `Phaser.TOP_RIGHT`, `Phaser.LEFT_CENTER`, \n`Phaser.CENTER`, `Phaser.RIGHT_CENTER`, `Phaser.BOTTOM_LEFT`, \n`Phaser.BOTTOM_CENTER` and `Phaser.BOTTOM_RIGHT`.\n\nThe Game Objects are placed in such a way that their _bounds_ align with the\ncontainer, taking into consideration rotation, scale and the anchor property.\nThis allows you to neatly align Game Objects, irrespective of their position value.\n\nThe optional `offsetX` and `offsetY` arguments allow you to apply extra spacing to the final\naligned position of the Game Object. For example:\n\n`sprite.alignIn(background, Phaser.BOTTOM_RIGHT, -20, -20)`\n\nWould align the `sprite` to the bottom-right, but moved 20 pixels in from the corner.\nThink of the offsets as applying an adjustment to the containers bounds before the alignment takes place.\nSo providing a negative offset will 'shrink' the container bounds by that amount, and providing a positive\none expands it."
     },
     "alignTo": {
      "!type": "fn(parent: +Phaser.Rectangle|+Phaser.Sprite|+Phaser.Image|+Phaser.Text|+Phaser.BitmapText|+Phaser.Button|+Phaser.Graphics|+Phaser.TileSprite, position: number, offsetX: number, offsetY: number) -> ?",
      "!doc": "Aligns this Game Object to the side of another Game Object, or Rectangle, known as the\n'parent', in one of 11 possible positions.\n\nThe parent must be a Game Object, or Phaser.Rectangle object. This can include properties\nsuch as `World.bounds` or `Camera.view`, for aligning Game Objects within the world \nand camera bounds. Or it can include other Sprites, Images, Text objects, BitmapText,\nTileSprites or Buttons.\n\nPlease note that aligning a Sprite to another Game Object does **not** make it a child of\nthe parent. It simply modifies its position coordinates so it aligns with it.\n\nThe position constants you can use are:\n\n`Phaser.TOP_LEFT` (default), `Phaser.TOP_CENTER`, `Phaser.TOP_RIGHT`, `Phaser.LEFT_TOP`, \n`Phaser.LEFT_CENTER`, `Phaser.LEFT_BOTTOM`, `Phaser.RIGHT_TOP`, `Phaser.RIGHT_CENTER`, \n`Phaser.RIGHT_BOTTOM`, `Phaser.BOTTOM_LEFT`, `Phaser.BOTTOM_CENTER` \nand `Phaser.BOTTOM_RIGHT`.\n\nThe Game Objects are placed in such a way that their _bounds_ align with the\nparent, taking into consideration rotation, scale and the anchor property.\nThis allows you to neatly align Game Objects, irrespective of their position value.\n\nThe optional `offsetX` and `offsetY` arguments allow you to apply extra spacing to the final\naligned position of the Game Object. For example:\n\n`sprite.alignTo(background, Phaser.BOTTOM_RIGHT, -20, -20)`\n\nWould align the `sprite` to the bottom-right, but moved 20 pixels in from the corner.\nThink of the offsets as applying an adjustment to the parents bounds before the alignment takes place.\nSo providing a negative offset will 'shrink' the parent bounds by that amount, and providing a positive\none expands it."
     }
    }
   },
   "Core": {
    "skipTypeChecks": {
     "!type": "bool",
     "!doc": "Skip type checks in {@link #init}."
    },
    "prototype": {
     "game": {
      "!type": "+Phaser.Game"
   ...
   "Destroy": {
    "prototype": {
     ...
     "destroy": {
      "!type": "fn(destroyChildren: bool, destroyTexture: bool)",
  ...
  "GameObjectFactory": {
   ...
   "prototype": {
    ...
    "image": {
     ...
     "!doc": "Create a new `Image` object.\n\rAn Image is a light-weight object you can use to display anything that doesn't need physics or animation.\n\rIt can still rotate, scale, crop and receive input events.\rThis makes it perfect for logos, backgrounds, simple buttons and other non-Sprite graphics."
    },
    "sprite": {
    ...
    "creature": {
     ...
     "!doc": "Create a new Creature Animation object.\n\nCreature is a custom Game Object used in conjunction with the Creature Runtime libraries by Kestrel Moon Studios.\n\rIt allows you to display animated Game Objects that were created with the [Creature Automated Animation Tool](http://www.kestrelmoon.com/creature/).\n\rNote 1: You can only use Phaser.Creature objects in WebGL enabled games. They do not work in Canvas mode games.\n\nNote 2: You must use a build of Phaser that includes the CreatureMeshBone.js runtime and gl-matrix.js, or have them\nloaded before your Phaser game boots.\n\rSee the Phaser custom build process for more details."
    },
    "tween": {
     "!type": "fn(object: ?) -> +Phaser.Tween",
     "!doc": "Create a tween on a specific object.\n\rThe object can be any JavaScript object or Phaser object such as Sprite."
    },
    "group": {
    ...
    "physicsGroup": {
     ...
     "!doc": "A Group is a container for display objects that allows for fast pooling, recycling and collision checks.\n\rA Physics Group is the same as an ordinary Group except that is has enableBody turned on by default, so any Sprites it creates\nare automatically given a physics body."
    },
    "spriteBatch": {
    ...
    "tileSprite": {
     "!type": "fn(x: number, y: number, width: number, height: number, key: string|+Phaser.BitmapData|+PIXI.Texture, frame: string|number, group: +Phaser.Group) -> +Phaser.TileSprite",
    ...
    "bitmapText": {
     ...
     "!doc": "Create a new BitmapText object.\n\nBitmapText objects work by taking a texture file and an XML file that describes the font structure.\nIt then generates a new Sprite object for each letter of the text, proportionally spaced out and aligned to\rmatch the font structure.\n\rBitmapText objects are less flexible than Text objects, in that they have less features such as shadows, fills and the ability\rto use Web Fonts. However you trade this flexibility for pure rendering speed. You can also create visually compelling BitmapTexts by\rprocessing the font texture in an image editor first, applying fills and any other effects required.\n\nTo create multi-line text insert \\r, \\n or \\r\\n escape codes into the text string.\n\nTo create a BitmapText data files you can use:\n\nBMFont (Windows, free): http://www.angelcode.com/products/bmfont/\nGlyph Designer (OS X, commercial): http://www.71squared.com/en/glyphdesigner\nLittera (Web-based, free): http://kvazars.com/littera/"
    },
    "tilemap": {
  ...
  "GameObjectCreator": {
   ...
   "prototype": {
    ...
    "tileSprite": {
     "!type": "fn(x: number, y: number, width: number, height: number, key: string|+Phaser.BitmapData|+PIXI.Texture, frame: string|number) -> +Phaser.TileSprite",
     "!doc": "Creates a new TileSprite object."
    },
    "rope": {
  ...
  "Image": {
   "!type": "fn(game: +Phaser.Game, x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+PIXI.Texture, frame: string|number)",
   "!doc": "An Image is a light-weight object you can use to display anything that doesn't need health, physics, or complex position monitoring.\n\nIt can still rotate, scale, crop and receive input events. This makes it perfect for logos, backgrounds, simple buttons and other non-Sprite graphics.",
   "prototype": {
    "type": {
     "!type": "number",
     "!doc": "The const type of this object."
  ...
  "BitmapData": {
   "!type": "fn(game: +Phaser.Game, key: string, width: number, height: number, skipPool: bool)",
   ...
   "prototype": {
    ...
    "smoothProperty": {
     "!type": "string",
     "!doc": "The context property needed for smoothing this Canvas."
    },
    "imageData": {
     "!type": "+ImageData",
    ...
    "move": {
     "!type": "fn(x: number, y: number, wrap: bool) -> +Phaser.BitmapData",
    ...
    "moveH": {
     "!type": "fn(distance: number, wrap: bool) -> +Phaser.BitmapData",
    ...
    "generateTexture": {
     "!type": "fn(key: string, callback: fn(), callbackContext: +any) -> +PIXI.Texture|+null",
    ...
    "copyTransform": {
     "!type": "fn(source: +Phaser.Sprite|+Phaser.Image|+Phaser.Text|+Phaser.BitmapData|+Phaser.BitmapText, blendMode: string, roundPx: bool) -> +Phaser.BitmapData",
     "!doc": "Draws the given `source` Game Object to this BitmapData, using its `worldTransform` property to set the\nposition, scale and rotation of where it is drawn. This function is used internally by `drawGroup`.\nIt takes the objects tint and scale mode into consideration before drawing.\n\nYou can optionally specify Blend Mode and Round Pixels arguments."
    },
    "copyRect": {
     "!type": "fn(source: +Phaser.Sprite|+Phaser.Image|+Phaser.Text|+Phaser.BitmapData|+Phaser.RenderTexture|+Image|string, area: +Phaser.Rectangle, x: number, y: number, alpha: number, blendMode: string, roundPx: bool) -> +Phaser.BitmapData",
     "!doc": "Copies the area defined by the Rectangle parameter from the source image to this BitmapData at the given location."
    },
    "draw": {
     "!type": "fn(source: +Phaser.Sprite|+Phaser.Image|+Phaser.Text|+Phaser.RenderTexture, x: number, y: number, width: number, height: number, blendMode: string, roundPx: bool) -> +Phaser.BitmapData",
  ...
  "Graphics": {
   ...
   "prototype": {
    ...
    "postUpdate": {
     "!type": "fn()",
     "!doc": "Automatically called by World"
    },
    "destroy": {
    ...
    "arcTo": {
     "!type": "fn(x1: number, y1: number, x2: number, y2: number, radius: number) -> +Graphics",
     "!doc": "The arcTo() method creates an arc/curve between two tangents on the canvas.\n\n\"borrowed\" from https://code.google.com/p/fxcanvas/ - thanks google!"
    },
    "arc": {
     "!type": "fn(cx: number, cy: number, radius: number, startAngle: number, endAngle: number, anticlockwise: bool, segments: number) -> +Graphics",
    ...
    "clear": {
     "!type": "fn() -> +Graphics",
     "!doc": "Clears the graphics that were drawn to this Graphics object, and resets fill and line style settings."
    },
    "generateTexture": {
     "!type": "fn(resolution: number, scaleMode: number, padding: number) -> +Texture",
    ...
    "getLocalBounds": {
     "!type": "fn() -> +Rectangle",
     "!doc": "Retrieves the non-global local bounds of the graphic shape as a rectangle. The calculation takes all visible children into consideration."
    },
    "updateLocalBounds": {
     "!type": "fn()",
  ...
  "RenderTexture": {
   "!type": "fn(game: +Phaser.Game, width: number, height: number, key: string, scaleMode: number, resolution: number)",
  ...
  "Text": {
   "!type": "fn(game: +Phaser.Game, x: number, y: number, text: string, style: +anonymousPhaserTextStyle)",
   ...
   "prototype": {
    ...
    "setStyle": {
     "!type": "fn(style: +PhaserTextsetStyleStyle, update: bool) -> +Phaser.Text",
    ...
    "setText": {
     "!type": "fn(text: string, immediate: bool) -> +Phaser.Text",
    ...
    "setCharacterLimit": {
     "!type": "fn(characterLimit: number, suffix: string)",
     "!doc": "Sets the character limit of the text, with a suffix.\nIf the text is longer than this limit, it is truncated and the suffix is appended."
    },
    "text": {
     "!type": "string"
    },
  ...
  "TileSprite": {
   "!type": "fn(game: +Phaser.Game, x: number, y: number, width: number, height: number, key: string|+Phaser.BitmapData|+PIXI.Texture, frame: string|number)",
   ...
   "prototype": {
    ...
    "tileScale": {
     "!type": "+Phaser.Point",
     "!doc": "The scale applied to the image being tiled."
    },
    "tileScaleOffset": {
     "!type": "+Phaser.Point",
     "!doc": "The scale offset applied to the image being tiled."
    },
    "tilePosition": {
     "!type": "+Phaser.Point",
     "!doc": "The offset position of the image being tiled."
    },
    "textureDebug": {
     "!type": "bool"
    },
    ...
    "setTexture": {
     "!type": "fn(texture: +PIXI.Texture) -> +Phaser.TileSprite",
     "!doc": "Changes the texture being rendered by this TileSprite.\nCauses a texture refresh to take place on the next render."
    },
    "generateTilingTexture": {
     "!type": "fn(forcePowerOfTwo: bool)",
     "!doc": "Internal method that generates a new tiling texture."
    },
    "getBounds": {
     "!type": "fn() -> +Phaser.Rectangle",
     "!doc": "Returns the framing rectangle of the Tile Sprite."
    }
   }
  },
  "CanvasPool": {
   "!type": "fn()",
   "!doc": "The CanvasPool is a global static object, that allows Phaser to recycle and pool Canvas DOM elements.",
   "create": {
   ...
   "remove": {
    "!type": "fn(parent: +any)",
    "!doc": "Looks up a canvas based on its parent, and if found puts it back in the pool, freeing it up for re-use.\nThe canvas has its width and height set to 1, and its parent attribute nulled."
   },
   "removeByCanvas": {
    "!type": "fn(canvas: +HTMLCanvasElement)",
    "!doc": "Looks up a canvas based on its type, and if found puts it back in the pool, freeing it up for re-use.\nThe canvas has its width and height set to 1, and its parent attribute nulled."
   },
   "getTotal": {
    "!type": "fn() -> number",
  ...
  "Canvas": {
   ...
   "getSmoothingPrefix": {
    "!type": "fn(context: +CanvasRenderingContext2D) -> string|+null",
  ...
  "Math": {
   ...
   "prototype": {
    ...
    "isPowerOfTwo": {
     ...
     "!doc": "Checks if the given dimensions make a power of two texture."
    },
    "random": {
     "!type": "fn(min: number, max: number) -> number",
     "!doc": "Returns a random float in the range `[min, max)`. If these parameters are not in order than they will be put in order.\nDefault is 0 for `min` and 1 for `max`."
    },
    "between": {
     "!type": "fn(min: number, max: number) -> number",
     "!doc": "Returns a random integer in the range `[min, max]`. If these parameters are not in order than they will be put in order.\nDefault is 0 for `min` and 1 for `max`."
    },
    "fuzzyEqual": {
    ...
    "floorTo": {
     "!type": "fn(value: number, place: number, base: number) -> number",
     "!doc": "Floors to some place comparative to a `base`, default is 10 for decimal place.\nThe `place` is represented by the power applied to `base` to get that place."
    },
    "ceilTo": {
     "!type": "fn(value: number, place: number, base: number) -> number",
     "!doc": "Ceils to some place comparative to a `base`, default is 10 for decimal place.\nThe `place` is represented by the power applied to `base` to get that place."
    },
    "rotateToAngle": {
     "!type": "fn(currentAngle: number, targetAngle: number, lerp: number) -> number",
     "!doc": "Rotates currentAngle towards targetAngle, taking the shortest rotation distance.\nThe lerp argument is the amount to rotate by in this call."
    },
    "getShortestAngle": {
     "!type": "fn(angle1: number, angle2: number) -> number",
     "!doc": "Gets the shortest angle between `angle1` and `angle2`.\nBoth angles must be in the range -180 to 180, which is the same clamped\nrange that `sprite.angle` uses, so you can pass in two sprite angles to\nthis method, and get the shortest angle back between the two of them.\n\nThe angle returned will be in the same range. If the returned angle is\ngreater than 0 then it's a counter-clockwise rotation, if < 0 then it's\na clockwise rotation."
    },
    "angleBetween": {
    ...
    "hypot": {
     "!type": "fn(a: number, b: number) -> number",
     "!doc": "Returns the length of the hypotenuse connecting two segments of given lengths."
    },
    "distance": {
     "!type": "fn(x1: number, y1: number, x2: number, y2: number) -> number",
  ...
  "AnimationManager": {
   ...
   "prototype": {
    ...
    "updateIfVisible": {
     "!type": "bool",
     "!doc": "Update the animation data only while the the sprite is {@link Phaser.Sprite#visible}. Set to `false` to continue updating while the sprite is invisible."
    },
    "isLoaded": {
     "!type": "bool",
  ...
  "Animation": {
   "!type": "fn(game: +Phaser.Game, parent: +Phaser.Sprite, name: string, frameData: +Phaser.FrameData, frames: [?]|[?], frameRate: number, loop: bool)",
   ...
   "prototype": {
    ...
    "isReversed": {
     "!type": "bool",
     "!doc": "Indicates if the animation will play backwards."
    },
    "play": {
    ...
    "reverse": {
     "!type": "fn() -> +Phaser.Animation",
     "!doc": "Reverses the animation direction."
    },
    "reverseOnce": {
     "!type": "fn() -> +Phaser.Animation",
     "!doc": "Reverses the animation direction for the current/next animation only\nOnce the onComplete event is called this method will be called again and revert\nthe reversed state."
    },
    "setFrame": {
    ...
    "reversed": {
     "!type": "bool",
     "!doc": "Gets and sets the isReversed state of this Animation."
    },
    "frameTotal": {
     "!type": "number",
     "!doc": "The total number of frames in the currently loaded FrameData, or -1 if no FrameData is loaded."
    ...
    "speed": {
     "!type": "number",
     "!doc": "Gets or sets the current speed of the animation in frames per second. Changing this in a playing animation will take effect from the next frame. Value must be greater than 0."
    },
    "enableUpdate": {
     "!type": "bool",
  ...
  "Frame": {
   ...
   "prototype": {
    ...
    "rotated": {
     "!type": "bool",
     "!doc": "Is the frame rotated in the source texture?"
    },
    "trimmed": {
     "!type": "bool",
  ...
  "AnimationParser": {
   ...
   "spriteSheet": {
    "!type": "fn(game: +Phaser.Game, key: string|+Image, frameWidth: number, frameHeight: number, frameMax: number, margin: number, spacing: number, skipFrames: number) -> +Phaser.FrameData",
  ...
  "Cache": {
   ...
   "prototype": {
    ...
    "addSpriteSheet": {
     "!type": "fn(key: string, url: string, data: ?, frameWidth: number, frameHeight: number, frameMax: number, margin: number, spacing: number, skipFrames: number)",
    ...
    "removeImage": {
     "!type": "fn(key: string, destroyBaseTexture: bool)",
  ...
  "Cache.DEFAULT": {
   "!type": "+PIXI.Texture",
   "!doc": "The default image used for a texture when no other is specified."
  },
  "Cache.MISSING": {
   "!type": "+PIXI.Texture",
   "!doc": "The default image used for a texture when the source image is missing."
  },
  "Loader": {
   "!type": "fn(game: +Phaser.Game)",
   ...
   "prototype": {
    ...
    "imageFromBitmapData": {
     "!type": "fn(key: string, bitmapData: +Phaser.BitmapData, overwrite: bool) -> +Phaser.Loader",
     "!doc": "Generate an image from a BitmapData object and add it to the current load queue."
    },
    "texture": {
     "!type": "fn(key: string, object: ?, overwrite: bool) -> +Phaser.Loader",
     "!doc": "Adds a Compressed Texture Image to the current load queue.\n\nCompressed Textures are a WebGL only feature, and require 3rd party tools to create.\nAvailable tools include Texture Packer, PVRTexTool, DirectX Texture Tool and Mali Texture Compression Tool.\n\nSupported texture compression formats are: PVRTC, S3TC and ETC1.\nSupported file formats are: PVR, DDS, KTX and PKM.\n\nThe formats that support all 3 compression algorithms are PVR and KTX.\nPKM only supports ETC1, and DDS only S3TC for now.\n\nThe texture path object looks like this:\n\n```\nload.texture('factory', {\n    etc1: 'assets/factory_etc1.pkm',\n    s3tc: 'assets/factory_dxt1.pvr',\n    pvrtc: 'assets/factory_pvrtc.pvr',\n    truecolor: 'assets/factory.png'\n});\n```\n\nThe `truecolor` property points to a standard PNG file, that will be used if none of the\ncompressed formats are supported by the browser / GPU.\n\nThe file is **not** loaded immediately after calling this method. The file is added to the queue ready to be loaded when the loader starts.\n\nThe key must be a unique String. It is used to add the file to the Phaser.Cache upon successful load.\n\nRetrieve the image via `Cache.getImage(key)`\n\nThe URL can be relative or absolute. If the URL is relative the `Loader.baseURL` and `Loader.path` values will be prepended to it.\n\nIf the URL isn't specified the Loader will take the key and create a filename from that. For example if the key is \"alien\"\nand no URL is given then the Loader will set the URL to be \"alien.pvr\". It will always add `.pvr` as the extension.\nIf you do not desire this action then provide a URL."
    },
    "images": {
    ...
    "spritesheet": {
     "!type": "fn(key: string, url: string, frameWidth: number, frameHeight: number, frameMax: number, margin: number, spacing: number, skipFrames: number) -> +Phaser.Loader",
  ...
  "LoaderParser": {
   ...
   "bitmapFont": {
    "!type": "fn(xml: ?, baseTexture: +PIXI.BaseTexture, xSpacing: number, ySpacing: number, frame: +Phaser.Frame, resolution: number) -> ?",
   ...
   "jsonBitmapFont": {
    "!type": "fn(json: ?, baseTexture: +PIXI.BaseTexture, xSpacing: number, ySpacing: number, frame: +Phaser.Frame, resolution: number) -> ?",
    "!doc": "Parse a Bitmap Font from a JSON file."
   },
   "pvr": {
    "!type": "fn(arrayBuffer: [?]) -> ?",
    "!doc": "Extract PVR header from loaded binary"
   },
   "dds": {
    "!type": "fn(arrayBuffer: [?]) -> ?",
    "!doc": "Extract DDS header from loaded binary"
   },
   "ktx": {
    "!type": "fn(arrayBuffer: [?]) -> ?",
    "!doc": "Extract KTX header from loaded binary"
   },
   "pkm": {
    "!type": "fn(arrayBuffer: [?]) -> ?",
    "!doc": "Extract PKM header from loaded binary"
   }
  },
  "AudioSprite": {
  ...
  "Sound": {
   ...
   "prototype": {
    ...
    "startTime": {
     "!type": "number",
     "!doc": "The time the sound starts at in ms (typically 0 unless starting from a marker)."
    },
    "currentTime": {
     "!type": "number",
     "!doc": "The current time of sound playback in ms."
    },
    "duration": {
     "!type": "number",
    ...
    "position": {
     "!type": "number",
     "!doc": "The position of the current sound marker in ms."
    },
    "stopTime": {
     "!type": "number",
     "!doc": "The time the sound stopped in ms."
    },
    "paused": {
     "!type": "bool",
    ...
    "pausedPosition": {
     "!type": "number",
     "!doc": "The position the sound had reached when it was paused in ms."
    },
    "pausedTime": {
     "!type": "number",
     "!doc": "The game time (ms) at which the sound was paused."
    },
    "isPlaying": {
     "!type": "bool",
    ...
    "onMute": {
     "!type": "+Phaser.Signal",
     "!doc": "The onMute event is dispatched when this sound is muted."
    },
    "onMarkerComplete": {
     "!type": "+Phaser.Signal",
    ...
    "volume": {
     "!type": "number",
     "!doc": "Gets or sets the volume of this sound, a value between 0 and 1. The value given is clamped to the range 0 to 1."
    }
   }
  },
  "SoundManager": {
  ...
  "ScaleManager": {
   ...
   "prototype": {
    ...
    "setUserScale": {
     "!type": "fn(hScale: number, vScale: +numer, hTrim: number, vTrim: number, queueUpdate: bool, force: bool)",
  ...
  "ArrayUtils": {
   ...
   "rotateRight": {
    "!type": "fn(array: [?]) -> +any",
    "!doc": "Moves the element from the end of the array to the start, shifting all items in the process.\nThe \"rotation\" happens to the right.\n\nBefore: `[ A, B, C, D, E, F ]`\nAfter: `[ F, A, B, C, D, E ]`\n\nSee also Phaser.ArrayUtils.rotateLeft."
   },
   "rotateLeft": {
    "!type": "fn(array: [?]) -> +any",
  ...
  "Create": {
   ...
   "prototype": {
    ...
    "texture": {
     "!type": "fn(key: string, data: +array, pixelWidth: number, pixelHeight: number, palette: number, generateTexture: bool, callback: fn(), callbackContext: +any) -> +PIXI.Texture|+Phaser.BitmapData",
    ...
    "grid": {
     "!type": "fn(key: string, width: number, height: number, cellWidth: number, cellHeight: number, color: string, generateTexture: bool, callback: fn(), callbackContext: +any) -> +PIXI.Texture|+Phaser.BitmapData",
     "!doc": "Creates a grid texture based on the given dimensions."
    },
    "copy": {
     "!type": "fn(dest: +Phaser.BitmapData, x: number, y: number, width: number, height: number, blendMode: string, roundPx: bool) -> +Phaser.BitmapData",
     "!doc": "Copies the contents of {@link bmd Create's canvas} to the given BitmapData object, or a new BitmapData object."
    }
   }
  },
  "Create.PALETTE_ARNE": {
  ...
  "Color": {
   ...
   "toABGR": {
    "!type": "fn(r: number, g: number, b: number, a: number) -> number",
    "!doc": "Converts RGBA components to a 32 bit integer in AABBGGRR format."
   },
   "hexToRGBArray": {
    "!type": "fn(color: number) -> +array",
    "!doc": "Converts a hex color value to an [R, G, B] array."
   },
   "RGBArrayToHex": {
    "!type": "fn(rgb: +array) -> number",
    "!doc": "Converts an RGB color array, in the format: [R, G, B], to a hex color value."
   },
   "RGBtoHSL": {
   ...
   "updateColor": {
    "!type": "fn(out: ?) -> number",
    "!doc": "Takes a color object and updates the rgba, color and color32 properties."
   },
   "getColor32": {
  ...
  "Physics": {
   ...
   "prototype": {
    ...
    "setBoundsToWorld": {
     "!type": "fn(left: bool, right: bool, top: bool, bottom: bool, setCollisionGroup: bool)",
   ...
   "Arcade": {
    "prototype": {
     ...
     "checkCollision": {
      "!type": "?",
      "!doc": "An object containing allowed collision flags (up, down, left, right)."
     },
     "maxObjects": {
      "!type": "number",
     ...
     "circleBodyIntersects": {
      "!type": "fn(circle: +Phaser.Physics.Arcade.Body, body: +Phaser.Physics.Arcade.Body) -> bool",
      "!doc": "Checks to see if a circular Body intersects with a Rectangular Body."
     },
     "getOverlapX": {
      "!type": "fn(body1: +Phaser.Physics.Arcade.Body, body2: +Phaser.Physics.Arcade.Body, overlapOnly: bool) -> +float",
     ...
     "distanceBetween": {
      "!type": "fn(source: +any, target: +any, world: bool) -> number",
     ...
     "distanceToXY": {
      "!type": "fn(displayObject: +any, x: number, y: number, world: bool) -> number",
     ...
     "distanceToPointer": {
      "!type": "fn(displayObject: +any, pointer: +Phaser.Pointer, world: bool) -> number",
     ...
     "angleBetweenCenters": {
      ...
      "!doc": "Find the angle in radians between centers of two display objects (like Sprites)."
     },
     "angleToXY": {
      "!type": "fn(displayObject: +any, x: number, y: number, world: bool) -> number",
    ...
    "Body": {
     "prototype": {
      ...
      "offset": {
       "!type": "+Phaser.Point",
       "!doc": "The offset of the Physics Body from the Sprite's texture."
      },
      "position": {
       "!type": "+Phaser.Point",
       "!doc": "The position of the physics body, equivalent to ({@link #left}, {@link #top})."
      },
      "prev": {
       "!type": "+Phaser.Point",
      ...
      "preRotation": {
       "!type": "number",
       "!doc": "The previous rotation of the physics body, in degrees."
      },
      "width": {
       "!type": "number",
      ...
      "velocity": {
       "!type": "+Phaser.Point",
       "!doc": "The velocity, or rate of change the Body's position. Measured in pixels per second."
      },
      "newVelocity": {
       "!type": "+Phaser.Point",
       "!doc": "The distanced traveled during the last update, equal to `velocity * physicsElapsed`. Calculated during the Body.preUpdate and applied to its position."
      },
      "deltaMax": {
       "!type": "+Phaser.Point",
      ...
      "allowDrag": {
       "!type": "bool",
       "!doc": "Allow this Body to be influenced by {@link #drag}?"
      },
      "drag": {
       "!type": "+Phaser.Point",
       "!doc": "The drag applied to the motion of the Body (when {@link #allowDrag} is enabled). Measured in pixels per second squared."
      },
      "allowGravity": {
       "!type": "bool",
      ...
      "gravity": {
       "!type": "+Phaser.Point",
       "!doc": "This Body's local gravity, **added** to any world gravity, unless Body.allowGravity is set to false."
      },
      "bounce": {
       "!type": "+Phaser.Point",
      ...
      "maxVelocity": {
       "!type": "+Phaser.Point",
       "!doc": "The maximum velocity (in pixels per second squared) that the Body can reach."
      },
      "friction": {
       "!type": "+Phaser.Point",
       "!doc": "If this Body is moving, and another Body is 'riding' this one, this is the amount of motion the riding Body receives on each axis."
      },
      "angularVelocity": {
       "!type": "number",
       "!doc": "The angular velocity is the rate of change of the Body's rotation. It is measured in degrees per second."
      },
      "angularAcceleration": {
       "!type": "number",
       "!doc": "The angular acceleration is the rate of change of the angular velocity. Measured in degrees per second squared."
      },
      "angularDrag": {
       "!type": "number",
       "!doc": "The drag applied during the rotation of the Body. Measured in degrees per second squared."
      },
      "maxAngular": {
       "!type": "number",
       "!doc": "The maximum angular velocity in degrees per second that the Body can reach."
      },
      "mass": {
       "!type": "number",
      ...
      "angle": {
       "!type": "number",
       "!doc": "The angle of the Body's **velocity** in radians."
      },
      "speed": {
       "!type": "number",
       "!doc": "The speed of the Body in pixels per second, equal to the magnitude of the velocity."
      },
      "facing": {
       "!type": "number",
       "!doc": "A const reference to the direction the Body is traveling or facing: Phaser.NONE, Phaser.LEFT, Phaser.RIGHT, Phaser.UP, or Phaser.DOWN. If the Body is moving on both axes, UP and DOWN take precedence."
      },
      "immovable": {
       "!type": "bool",
       "!doc": "An immovable Body will not receive any impacts from other bodies. **Two** immovable Bodies can't separate or exchange momentum and will pass through each other."
      },
      "moves": {
       "!type": "bool",
      ...
      "overlapR": {
       "!type": "number",
       "!doc": "The amount of overlap during the collision."
      },
      "embedded": {
       "!type": "bool",
      ...
      "checkCollision": {
       "!type": "?",
       "!doc": "An object containing allowed collision (none, up, down, left, right)."
      },
      "touching": {
       "!type": "?",
       "!doc": "An object containing touching results (none, up, down, left, right)."
      },
      "wasTouching": {
       "!type": "?",
       "!doc": "An object containing previous touching results (none, up, down, left, right)."
      },
      "blocked": {
       "!type": "?",
       "!doc": "An object containing on which faces this Body is blocked from moving, if any (none, up, down, left, right)."
      },
      "tilePadding": {
       "!type": "+Phaser.Point",
      ...
      "isMoving": {
       "!type": "bool",
       "!doc": "Set by the `moveTo` and `moveFrom` methods."
      },
      ...
      "onMoveComplete": {
       "!type": "+Phaser.Signal",
       "!doc": "Listen for the completion of `moveTo` or `moveFrom` events."
      },
      "movementCallback": {
       "!type": "fn()",
       "!doc": "Optional callback. If set, invoked during the running of `moveTo` or `moveFrom` events."
      },
      "movementCallbackContext": {
       "!type": "?",
       "!doc": "Context in which to call the movementCallback."
      },
      "updateBounds": {
       "!type": "fn()",
       "!doc": "Internal method."
      ...
      "updateCenter": {
       "!type": "fn()",
       "!doc": "Update the Body's center from its position."
      },
      "preUpdate": {
       "!type": "fn()",
       "!doc": "Internal method."
      ...
      "stop": {
       "!type": "fn()",
       "!doc": "Sets acceleration, velocity, and {@link #speed} to 0."
      },
      "getBounds": {
       "!type": "fn(obj: ?) -> ?",
       "!doc": "Returns the bounds of this physics body.\n\nOnly used internally by the World collision methods."
      },
      "hitTest": {
       "!type": "fn(x: number, y: number) -> bool",
      ...
      "render": {
       "!type": "fn(context: ?, body: +Phaser.Physics.Arcade.Body, color: string, filled: bool, lineWidth: number)",
    ...
    "Body": {
     "prototype": {
      ...
      "removeCollisionGroup": {
       "!type": "fn(group: +Phaser.Physics.CollisionGroup|+array, clearCallback: bool, shape: +p2.Shape)",
      ...
      "loadPolygon": {
       "!type": "fn(key: string, object: string|?, scale: number) -> bool",
  ...
  "Tilemap": {
   ...
   "prototype": {
    ...
    "enableDebug": {
     "!type": "bool",
     "!doc": "If set then console.log is used to dump out useful layer creation debug data."
    },
    "currentLayer": {
     "!type": "number",
    ...
    "createFromObjects": {
     "!type": "fn(name: string, gid: number|string, key: string, frame: number|string, exists: bool, autoCull: bool, group: +Phaser.Group, CustomClass: ?, adjustY: bool)",
     "!doc": "Creates a Sprite for every {@link http://doc.mapeditor.org/reference/tmx-map-format/#object object} matching the `gid` argument. You can optionally specify the group that the Sprite will be created in. If none is\ngiven it will be created in the World. All properties from the map data objectgroup are copied across to the Sprite, so you can use this as an easy way to\nconfigure Sprite properties from within the map editor. For example giving an object a property of `alpha: 0.5` in the map editor will duplicate that when the\nSprite is created. You could also give it a value like: `body.velocity.x: 100` to set it moving automatically.\n\nThe `gid` argument is matched against:\n\n1. For a tile object, the tile identifier (`gid`); or\n2. The object's unique ID (`id`); or\n3. The object's `name` (a string)"
    },
    "createFromTiles": {
    ...
    "setCollision": {
     ...
     "!doc": "Sets collision on the given tile or tiles. You can pass in either a single numeric index or an array of indexes: [2, 3, 15, 20].\nThe `collides` parameter controls if collision will be enabled (true) or disabled (false).\n\nCollision-enabled tiles can be collided against Sprites using {@link Phaser.Physics.Arcade#collide}."
    },
    "setCollisionBetween": {
  ...
  "TilemapLayer": {
   ...
   "prototype": {
    ...
    "getLayerOffsetX": {
     "!type": "fn() -> number",
     "!doc": "Get the X axis position offset of this layer's tiles."
    },
    "getTileOffsetY": {
     "!type": "fn() -> number",
     "!doc": "Get the Y axis position offset of this layer's tiles."
    },
    "getTileX": {
     "!type": "fn(x: number) -> number",
  ...
  "TilemapParser": {
   ...
   "parse": {
    "!type": "fn(game: +Phaser.Game, key: string, tileWidth: number, tileHeight: number, width: number, height: number) -> ?",
    "!doc": "Parse tilemap data from the cache and creates data for a Tilemap object."
   },
   "parseCSV": {
    "!type": "fn(key: string, data: string, tileWidth: number, tileHeight: number) -> ?",
   ...
   "Arcade": {
    ...
    "Emitter": {
     "prototype": {
      ...
      "minAngle": {
       "!type": "number",
       "!doc": "The minimum angle of initial particle velocities, in degrees. When set to a non-null value (with {@link #maxAngle}), {@link #minSpeed} and {@link #maxSpeed} are used and {@link #minParticleSpeed} and {@link #maxParticleSpeed} are ignored."
      },
      "maxAngle": {
       "!type": "number",
       "!doc": "The maximum angle of initial particle velocities, in degrees. When set to a non-null value (with {@link #minAngle}), {@link #minSpeed} and {@link #maxSpeed} are used and {@link #minParticleSpeed} and {@link #maxParticleSpeed} are ignored."
      },
      "minSpeed": {
       "!type": "number",
       "!doc": "The minimum initial speed of particles released within {@link #minAngle} and {@link #maxAngle}."
      },
      "maxSpeed": {
       "!type": "number",
       "!doc": "The maximum initial speed of particles released within {@link #minAngle} and {@link #maxAngle}."
      },
      "minParticleSpeed": {
       "!type": "+Phaser.Point",
      ...
      "makeParticles": {
       "!type": "fn(keys: +array|string, frames: +array|number, quantity: number, collide: bool, collideWorldBounds: bool, particleArguments: ?) -> +Phaser.Particles.Arcade.Emitter",
      ...
      "flow": {
       "!type": "fn(lifespan: number, frequency: number, quantity: number, total: number, immediate: bool) -> +Phaser.Particles.Arcade.Emitter",
      ...
      "setAlpha": {
       "!type": "fn(min: number, max: number, rate: number, ease: fn(), yoyo: bool) -> +Phaser.Particles.Arcade.Emitter",
      ...
      "setScale": {
       "!type": "fn(minX: number, maxX: number, minY: number, maxY: number, rate: number, ease: fn(), yoyo: bool) -> +Phaser.Particles.Arcade.Emitter",
      ...
      "setAngle": {
       "!type": "fn(minAngle: number, maxAngle: number, minSpeed: number, maxSpeed: number) -> +Phaser.Particles.Arcade.Emitter",
       "!doc": "Sets a radial pattern for emitting particles.\n\nThis is a shorthand for setting {@link #minAngle}, {@link #maxAngle}, {@link #minSpeed}, and {@link #maxSpeed}.\n\nTo remove the radial pattern, use `setAngle(null, null)`."
      },
      "at": {
       "!type": "fn(object: ?|+Phaser.Sprite|+Phaser.Image|+Phaser.TileSprite|+Phaser.Text|+PIXI.DisplayObject) -> +Phaser.Particles.Arcade.Emitter",
      ...
      "gravity": {
       "!type": "+Phaser.Point",
       "!doc": "Sets the `body.gravity` of each particle sprite to this on launch."
      },
      "id": {
       "!type": "number",
       "!doc": "Gets the internal ID that represents this emitter."
      },
      "width": {
       "!type": "number",
      ...
      "output": {
       "!type": "number",
       "!doc": "The number of particles released per second, after calling {@link #flow}."
      },
      "lifespanOutput": {
       "!type": "number",
       "!doc": "The number of particles released during one particle's {@link #lifespan}, after calling {@link #flow}."
      },
      "remainder": {
       "!type": "number",
       "!doc": "The expected number of unreleased particles after a flow interval of {@link #lifespan}, after calling {@link #flow}."
      },
      "add": {
       "!type": "fn(child: +DisplayObject, silent: bool, index: number) -> +DisplayObject",
       "!doc": "Adds an existing object as the top child in this group.\n\nThe child is automatically added to the top of the group, and is displayed above every previous child.\n\nOr if the _optional_ index is specified, the child is added at the location specified by the index value,\nthis allows you to control child ordering.\n\nIf the child was already in this Group, it is simply returned, and nothing else happens to it.\n\nIf `Group.enableBody` is set, then a physics body will be created on the object, so long as one does not already exist.\n\nIf `Group.inputEnableChildren` is set, then an Input Handler will be created on the object, so long as one does not already exist.\n\nUse {@link #addAt} to control where a child is added. Use {@link #create} to create and add a new child."
  ...
  "Weapon": {
   "!type": "fn(game: +Phaser.Game, parent: +Phaser.PluginManager)",
   "!doc": "The Weapon Plugin provides the ability to easily create a bullet pool and manager.\n\nWeapons fire Phaser.Bullet objects, which are essentially Sprites with a few extra properties.\nThe Bullets are enabled for Arcade Physics. They do not currently work with P2 Physics.\n\nThe Bullets are created inside of `Weapon.bullets`, which is a Phaser.Group instance. Anything you\ncan usually do with a Group, such as move it around the display list, iterate it, etc can be done\nto the bullets Group too.\n\nBullets can have textures and even animations. You can control the speed at which they are fired,\nthe firing rate, the firing angle, and even set things like gravity for them.\n\nA small example, assumed to be running from within a Phaser.State create method.\n\n`var weapon = this.add.weapon(10, 'bullet');`\n`weapon.fireFrom.set(300, 300);`\n`this.input.onDown.add(weapon.fire, this);`",
   "prototype": {
    "bullets": {
     "!type": "+Phaser.Group",
     "!doc": "This is the Phaser.Group that contains all of the bullets managed by this plugin."
    },
    "autoExpandBulletsGroup": {
     "!type": "bool",
     "!doc": "Should the bullet pool run out of bullets (i.e. they are all in flight) then this\nboolean controls if the Group will create a brand new bullet object or not."
    },
    "autofire": {
     "!type": "bool",
     "!doc": "Will this weapon auto fire? If set to true then a new bullet will be fired\nbased on the `fireRate` value."
    },
    "shots": {
     "!type": "number",
     "!doc": "The total number of bullets this Weapon has fired so far.\nYou can limit the number of shots allowed (via `fireLimit`), and reset\nthis total via `Weapon.resetShots`."
    },
    "fireLimit": {
     "!type": "number",
     "!doc": "The maximum number of shots that this Weapon is allowed to fire before it stops.\nWhen the limit is his the `Weapon.onFireLimit` Signal is dispatched.\nYou can reset the shot counter via `Weapon.resetShots`."
    },
    "fireRate": {
     "!type": "number",
     "!doc": "The rate at which this Weapon can fire. The value is given in milliseconds."
    },
    "fireRateVariance": {
     "!type": "number",
     "!doc": "This is a modifier that is added to the `fireRate` each update to add variety\nto the firing rate of the Weapon. The value is given in milliseconds.\nIf you've a `fireRate` of 200 and a `fireRateVariance` of 50 then the actual\nfiring rate of the Weapon will be between 150 and 250."
    },
    "fireFrom": {
     "!type": "+Phaser.Rectangle",
     "!doc": "This is a Rectangle from within which the bullets are fired. By default it's a 1x1\nrectangle, the equivalent of a Point. But you can change the width and height, and if\nlarger than 1x1 it'll pick a random point within the rectangle to launch the bullet from."
    },
    "fireAngle": {
     "!type": "number",
     "!doc": "The angle at which the bullets are fired. This can be a const such as Phaser.ANGLE_UP\nor it can be any number from 0 to 360 inclusive, where 0 degrees is to the right."
    },
    "bulletInheritSpriteSpeed": {
     "!type": "bool",
     "!doc": "When a Bullet is fired it can optionally inherit the velocity of the `trackedSprite` if set."
    },
    "bulletAnimation": {
     "!type": "string",
     "!doc": "The string based name of the animation that the Bullet will be given on launch.\nThis is set via `Weapon.addBulletAnimation`."
    },
    "bulletFrameRandom": {
     "!type": "bool",
     "!doc": "If you've added a set of frames via `Weapon.setBulletFrames` then you can optionally\nchose for each Bullet fired to pick a random frame from the set."
    },
    "bulletFrameCycle": {
     "!type": "bool",
    ...
    "debug": {
     "!type": "fn(x: number, y: number, debugBodies: bool)",
     "!doc": "Uses `Game.Debug` to draw some useful information about this Weapon, including the number of bullets\nboth in-flight, and available. And optionally the physics debug bodies of the bullets."
    },
    "bulletClass": {
     "!type": "fn()"
    },
  ...
  "Weapon.KILL_NEVER": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that stops the bullets from ever being destroyed automatically."
  },
  "Weapon.KILL_LIFESPAN": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that automatically kills the bullets when their `bulletLifespan` expires."
  },
  "Weapon.KILL_DISTANCE": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that automatically kills the bullets after they\nexceed the `bulletDistance` from their original firing position."
  },
  "Weapon.KILL_WEAPON_BOUNDS": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that automatically kills the bullets when they leave the `Weapon.bounds` rectangle."
  },
  "Weapon.KILL_CAMERA_BOUNDS": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that automatically kills the bullets when they leave the `Camera.bounds` rectangle."
  },
  "Weapon.KILL_WORLD_BOUNDS": {
   "!type": "number",
   "!doc": "A `bulletKillType` constant that automatically kills the bullets when they leave the `World.bounds` rectangle."
  },
  ...
  "Bullet": {
   "!type": "fn(game: +Phaser.Game, x: number, y: number, key: string|+Phaser.RenderTexture|+Phaser.BitmapData|+PIXI.Texture, frame: string|number)",
   "!doc": "Create a new `Bullet` object. Bullets are used by the `Phaser.Weapon` class, and are normal Sprites,\nwith a few extra properties in the data object to handle Weapon specific features.",
   "prototype": {
    "kill": {
     "!type": "fn()",
     "!doc": "Updates the Bullet, killing as required."
    },
    "preUpdate": {
     "!type": "fn() -> bool",
     "!doc": "Automatically called by World.preUpdate."
  ...
  "Video": {
   ...
   "prototype": {
    ...
    "onComplete": {
     "!type": "+Phaser.Signal",
     "!doc": "This signal is dispatched when the Video completes playback, i.e. enters an 'ended' state. On iOS specifically it also fires if the user hits the 'Done' button at any point during playback. Videos set to loop will never dispatch this signal."
    },
    "onAccess": {
     "!type": "+Phaser.Signal",
 ...
 "module:PIXI~PIXI": {
  "WebGLGraphics": {
   "stencilBufferLimit": {
    "!type": "number",
    "!doc": "The number of points beyond which Pixi swaps to using the Stencil Buffer to render the Graphics."
   }
  }
 },
 "module:PIXI~p2": {
